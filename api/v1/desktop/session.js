...
module.exports = async (req, res) => {
  ...
  if (!await serviceRateLimit('desktop_session', match[1], 240, 3600)) return json(res, 429, { ok: false, error: 'Muitas validações de sessão. Aguarde e tente novamente.' }, { 'retry-after': '30' });
