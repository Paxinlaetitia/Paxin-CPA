'use strict';
const { json, readBody, serviceUpstream, serviceRateLimit, clientAddress, isUuid, sha256 } = require('../../_paxinbot');
module.exports = async (req, res) => {
  ...
  const { response, payload } = await serviceUpstream('/rest/v1/rpc/paxinbot_device_poll_v2', { method: 'POST', body: { p_request_id: body.requestId, p_secret_hash: sha256(body.secret) } });
