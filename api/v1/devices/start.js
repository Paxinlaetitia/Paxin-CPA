...
module.exports = async (req, res) => {
  ...
  const { response } = await upstream('/rest/v1/rpc/paxinbot_device_start', { method: 'POST', body: { p_request_id: requestId, p_secret_hash: sha256(secret), p_user_code: userCode, p_device_name: String(body.deviceName || 'Computador Paxinbot'), p_app_version: String(body.appVersion || '2.6.0') } });
